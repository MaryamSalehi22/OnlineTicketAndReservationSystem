...
namespace Infrastructure
{
    public class OnlineTicketAndReservationDbContext : IdentityDbContext<User, Role, Guid>
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-DCVH6RQ\\MSSQLSERVER2;Initial Catalog=OnlineTicketDb;TrustServerCertificate=True;Integrated Security=SSPI");
            }
        }
